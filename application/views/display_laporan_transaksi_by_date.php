      ...
      <div class="container">
        <table  Align="center" class="table table-bordered laporan">
		   <?php
            ...
            $tanggal_sort=date_create($date);
            
            ?>
		<h3>Laporan Data Transaksi pada  <?php echo  date_format($tanggal_sort, 'l jS F Y');?>  </h3>
		<?php echo form_open('c_main/search');?>
			<center>
				<tr>
                    ...
                    <?php echo form_open('c_main/sort_laporan_transaksi_by_date'); ?>
                    <td>Sort By Date : </td>
                    <td><input type="date" name="sort_date">
                        <input class="btn btn-default" type="submit" value="Sort by Date"/></td>
                    <?php echo form_close(); ?>
                    
                    <?php echo form_open('c_main/sort_laporan_transaksi_by_month'); ?>
                    <td>
                    Sort By Month
