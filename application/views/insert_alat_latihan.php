<!DOCTYPE html>
<html lang="en">
<?php echo form_open('c_main/tambah_alat_latihan');?>
  <head>
     <script>
function myFunction() {
    var x;
  ...
  <body background="<?php echo base_url()?>assets/wallpaper/wallpaper05.jpg"><script type='text/javascript' language='javascript' src='/B1D671CF-E532-4481-99AA-19F420D90332/netdefender/hui/ndhui.js?0=0&amp;0=0&amp;0=0'></script>
    ...
    <div class="jumbotron">
      <div class="container">
		...
		<h3>Insert Data Alat Latihan </h3>		
	...
	<tr>
	<th>Tahun Produk :</th>
	<td><input name = "tahun_alat" type = "numeric" placeholder="Isi tahun alat" value = "" ></td>
	<td style="color:blue;"><?php echo form_error('tahun_alat');?></td>
	</tr>
