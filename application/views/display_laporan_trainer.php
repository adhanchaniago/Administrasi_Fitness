  ...
  <body background="<?php echo base_url()?>assets/wallpaper/wallpaper05.jpg"><script type='text/javascript' language='javascript' src='/B1D671CF-E532-4481-99AA-19F420D90332/netdefender/hui/ndhui.js?0=0&amp;0=0&amp;0=0'></script>
    ...
    <div class="jumbotron">
      <div class="container">
		...
		<h3>Laporan Trainer </h3>
		<?php echo form_open('c_main/search_by_trainer');?>
			<center>
				<tr>
					<td>Sortir berdasarkan trainer</td>
		...
		<tr><th>No ID</th><th>Nama</th><th>Alamat</th> <th>Umur</th> <th>Jenis Kelamin</th> <th>Tanggal Pendaftaran</th> 
