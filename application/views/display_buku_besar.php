    ...
    <div class="jumbotron">
      <div class="container">
		...
		<?php echo form_close(); ?>
                ...
                <h2><?php echo $title_bukubesar ;?></h2>
		...
		?>
                ...
                <tr>
                    ...
                    <td></td>
                    <td><?php  
            $total_query="SELECT SUM(Debit) AS TotalTransaksi FROM akuntansi_perusahaan";
            ...
            ?></td>
               ...
               <td><?php  
            $total_query="SELECT SUM(Credit) AS TotalTransaksi FROM akuntansi_perusahaan";
            $cdresult=mysql_query($total_query) or die ("Query to get data from firsttable failed: ".mysql_error());
            while ($cdrow=mysql_fetch_array($cdresult)) {
